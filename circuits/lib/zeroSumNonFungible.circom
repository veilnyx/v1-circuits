...
template ZeroSumNonFungible(nIns, nOuts) {
    ...
    inForceEqualIfNonFungible.in[0] <== inCountNft.out + (1 - publicFlow) * publicCountNft.out;
    ...
    outForceEqualIfNonFungible.in[0] <== outCountNft.out + publicFlow * publicCountNft.out;
